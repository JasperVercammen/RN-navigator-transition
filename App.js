...
import { Button, Dimensions, Easing, View, ScrollView, Animated, ImageBackground, StyleSheet, Text } from 'react-native';
...
class MyHomeScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <ImageBackground style={styles.container} resizeMode='stretch' source={require('./images/rectangle12.png')}>
